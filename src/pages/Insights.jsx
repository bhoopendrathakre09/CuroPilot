...
export default function Insights() {
  ...
  return (
    <>
      <Helmet>
        <title>Insights | CuroPilot – Emergency Response Analytics</title>
        <meta name="description" content="Discover key insights from real emergency cases, ambulance-hospital coordination, and how CuroPilot improves patient outcomes during the Golden Hour." />
        <link rel="canonical" href="https://curopilot.com/insights" />
      </Helmet>
