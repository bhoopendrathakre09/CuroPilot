...
export default function Survey() {
  return (
    <>
      <Helmet>
        <title>CuroPilot Survey | Share Emergency Experiences</title>
        <meta name="description" content="Share your emergency experience to help CuroPilot improve hospital and ambulance coordination during critical emergencies." />
        <link rel="canonical" href="https://curopilot.com/survey" />
      </Helmet>
