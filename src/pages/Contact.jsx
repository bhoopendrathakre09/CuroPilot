...
export default function Contact() {
  ...
  return (
    <>
      <Helmet>
        <title>Contact CuroPilot | Emergency Coordination Platform</title>
        <meta name="description" content="Get in touch with CuroPilot to share data, request a demo, or connect emergency stakeholders." />
        <link rel="canonical" href="https://curopilot.com/contact" />
      </Helmet>
