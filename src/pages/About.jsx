...
export default function About() {
  return (
    <>
      <Helmet>
        <title>About CuroPilot | Emergency Coordination Platform</title>
        <meta name="description" content="Learn about CuroPilot, our mission to improve emergency response, and how we connect hospitals, ambulances, and citizens to save lives during the Golden Hour." />
        <link rel="canonical" href="https://curopilot.com/about" />
        <meta property="og:title" content="About CuroPilot | Emergency Coordination Platform" />
        <meta property="og:description" content="Learn about CuroPilot, our mission to improve emergency response, and how we connect hospitals, ambulances, and citizens to save lives during the Golden Hour." />
        <meta property="og:url" content="https://curopilot.com/about" />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="About CuroPilot | Emergency Coordination Platform" />
        <meta name="twitter:description" content="Learn about CuroPilot, our mission to improve emergency response, and how we connect hospitals, ambulances, and citizens to save lives during the Golden Hour." />
      </Helmet>
